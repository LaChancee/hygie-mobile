...
class Question5Page extends StatefulWidget {
  ...
  const Question5Page({Key? key, required this.dependanceType})
      : super(key: key);
...
class _Question5PageState extends State<Question5Page> {
  ...
  String getQuestionText() {
    if (widget.dependanceType == 'tabac') {
      return 'Fumez-vous à un rythme plus soutenu le matin que durant le reste de la journée ?';
    } else {
      return 'Consommez-vous de l\'alcool à un rythme plus soutenu le matin que durant le reste de la journée ?';
    }
  }
