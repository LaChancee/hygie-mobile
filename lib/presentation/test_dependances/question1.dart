...
class Question1Page extends StatefulWidget {
  ...
  const Question1Page({Key? key, required this.dependanceType})
      : super(key: key);
...
class _Question1PageState extends State<Question1Page> {
  ...
  // Options pour le tabac
  final List<String> tabacOptions = [
    'Dans les 5 premières minutes',
    'Entre 6 à 30 minutes',
  ...
  String getQuestionText() {
    if (widget.dependanceType == 'tabac') {
      ...
      return 'Combien de temps après votre réveil consommez-vous votre première boisson alcoolisée ?';
    }
  }

  List<String> getOptions() {
    return tabacOptions; // Pour l'instant, on utilise les mêmes options pour le tabac et l'alcool
  }
  ...
  void _selectOption(int index) {
    ...
    // Sauvegarder la réponse dans le provider
    Provider.of<DependanceTestProvider>(context, listen: false)
        .saveResponse(1, index); // 1 est le numéro de la première question
  }
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 12.0),
                      child: _buildStepIndicator('Questions', true, 0.25),
                    ),
                  ),
                  Expanded(
                    child: Padding(
