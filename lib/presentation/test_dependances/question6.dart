...
class _Question6PageState extends State<Question6Page> {
  ...
  String getQuestionText() {
    if (widget.dependanceType == 'tabac') {
      return 'Fumez-vous lorsque vous êtes malade au point de devoir rester au lit presque toute la journée ?';
    } else {
      return 'Consommez-vous de l\'alcool lorsque vous êtes malade au point de devoir rester au lit presque toute la journée ?';
    }
  }
  ...
  void _selectOption(int index) {
    ...
    Provider.of<DependanceTestProvider>(context, listen: false)
        .saveResponse(6, index); // 6 est le numéro de la dernière question
  }
  ...
  void _goToNextQuestion() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ResultatDependancePage(
